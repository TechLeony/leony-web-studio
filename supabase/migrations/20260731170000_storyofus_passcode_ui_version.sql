...
alter table public.storyofus_submissions
  drop constraint if exists storyofus_submissions_passcode_ui_version_check;

alter table public.storyofus_submissions
  add constraint storyofus_submissions_passcode_ui_version_check
  check (
...
begin
  ...
  set
    ...
    passcode_ui_version = coalesce(submission.passcode_ui_version, 'demo_v1'),
    delivered_at = v_now,
    updated_at = v_now
