...
const TR: Dict = {
  ...
  demos: {
    ...
    items: {
      cafe: { title: "Mira Bistro QR Menü", sectorSlug: "cafe-restoran", desc: "Mobil öncelikli QR menü, fiyat listesi ve temel işletme tanıtımı için hazırlanmış demo.", badges: ["qrMenu", "mobileFriendly", "priceList", "basicPackage"] },
    ...
    items: {
      baslangic: {
        ...
        features: [
          ...
          "Google’da görünürlük için temel SEO yapısı",
          "Müşterinin verdiği metinleri düzenleme desteği",
      ...
      profesyonel: {
        ...
        features: [
          ...
          "Gelişmiş iletişim ve dönüşüm takibi (form, WhatsApp, CTA, paket talepleri)",
          "5 sayfaya kadar temel metin düzenleme",
...
const AZ: Dict = {
    ...
    items: {
      baslangic: {
        ...
        features: [
          ...
          "Google görünürlüyü üçün əsas SEO strukturu",
          "Müştərinin verdiyi mətnlərin redaktə dəstəyi",
      ...
      profesyonel: {
        ...
        features: [
          ...
          "İnkişaf etmiş əlaqə və dönüşüm izləməsi (form, WhatsApp, CTA, paket sorğuları)",
          "5 səhifəyə qədər əsas mətn redaktəsi",
  ...
  customCatModal: {
    ...
    submit: "Sorğumu göndər",
    submitting: "Göndərilir...",
    errors: { name: "Ad soyad tələb olunur", category: "Kateqoriya tələb olunur", email: "Düzgün email daxil edin", phone: "Zəhmət olmasa, düzgün WhatsApp nömrəsi daxil edin.", message: "Qısa mesaj yazın" },
    ...
    successTitle: "Sorğunuz qəbul edildi",
    toastSuccess: "Sorğunuz yaradıldı. Ən qısa zamanda sizinlə əlaqə saxlayacağıq.",
    toastError: "Sorğunuz yaradılarkən problem baş verdi. Zəhmət olmasa, yenidən cəhd edin.",
  },
  switcher: { aria: "Dil seç" },
  waMessages: {
...
const EN: Dict = {
    ...
    items: {
      baslangic: {
        ...
        features: [
          ...
          "WhatsApp routing",
          "Social media links",
          "Basic SEO structure for Google visibility",
          "Editing support for text you provide",
      ...
      profesyonel: {
        ...
        features: [
          ...
          "Advanced contact and conversion tracking (forms, WhatsApp, CTA, package interest)",
          "Basic text editing for up to 5 pages",
  ...
  customCatModal: {
    ...
    submitting: "Sending...",
    errors: { name: "Full name is required", category: "Category is required", email: "Enter a valid email", phone: "Please enter a valid WhatsApp number.", message: "Please write a short message" },
    ...
    toastSuccess: "Your request has been created. We will get back to you shortly.",
    toastError: "Something went wrong while creating your request. Please try again.",
  },
